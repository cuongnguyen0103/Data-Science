...
if choice == 'Đồ án':
    ...
    if query:
        ...
        similar_hotels_df = similar_hotels_df[similar_hotels_df['Similarity']>0][['Hotel_ID', 'Hotel_Name', 'Hotel_Description','Similarity']]
    ...
    data_comments = pd.read_csv('data_comments_new.csv')
    # Lấy 10 khách sạn
